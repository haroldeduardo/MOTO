...
public class CompraBean implements Serializable {
    ...
    public void agregarDatosProducto(Integer idProducto){
        this.sessionCompra=null;
        this.transactionCompra=null;
        ...
        try {
            ...
            this.transactionCompra = this.sessionCompra.beginTransaction();
            this.producto = pDao.obtenerProductoPorId(this.sessionCompra, idProducto);
            
            this.listaDetalleCompra.add(new DetalleCompra(0,this.producto.getIdProducto(),this.producto.getValorCompraProducto(),this.producto.getValorVentaProducto(),0));
    ...
    public void agregarDatosProductoPorCodigo(){
        this.sessionCompra=null;
        this.transactionCompra=null;
        ...
        try {
            ...
            ProductoDao pDao = new ProductoDaoImp();
            this.transactionCompra = this.sessionCompra.beginTransaction();
            this.producto = pDao.obtenerProductoPorCodigo(this.sessionCompra, this.codigoProducto);
