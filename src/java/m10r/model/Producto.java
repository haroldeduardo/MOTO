...
public class Producto  implements java.io.Serializable {
    ...
    public Producto(String codigoProducto, String nombreProducto, String descripcionProducto, int stockProducto, float valorCompraProducto, float valorVentaProducto, String iva, int idCategoria, int idPresentacionProducto, int idUbicacionProducto) {
